...
class UserMapperTest {
    ...
    void entityToDTO() {
        ...
        val excepted = List.of(
                UserDTO.builder().id(0).login("Vantuz").name("Иван").gender(ru.b19513.pet_manager.controller.entity.enums.Gender.MALE).build(),
                UserDTO.builder().id(1).login("Jawa").about("Поделил на ноль").name("Джава").gender(ru.b19513.pet_manager.controller.entity.enums.Gender.MALE).build()
        );
